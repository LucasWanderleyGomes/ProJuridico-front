  ...
  api.delete(`/api/v2/processos/${id}/`)
    .then((res) => {
      if (res.status === 204) {
        ...
        alert(`Processo ${id} deletado com sucesso!`);
      } else {
...
const handleEsconderProcesso = (id) => {
  setEscondidos((prev) => [...prev, id]);
    ...
    <>
      ...
      <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
              ...
              >
                <div className='content-motion'>
                  ...
                  <div className="left-container-info">
                    ...
                    <h4 className='titulo-cars-port'> Proteção</h4>
                    ...
                    <div className='div-numero-slide'>
                      <p className='id-slider-port'>2</p>
                    </div>
                  </div>
                    ...
                    >  
                      <div className='content-motion'>
                        ...
                        <div className="left-container-info">
                          ...
                          <h4 className='titulo-cars-port'>Responsáveis</h4>
                          ...
                          <div className='div-numero-slide'>
                            <p className='id-slider-port'>3</p>
                          </div>
        ...
        <button id='previous-but' class="carousel-control-prev" type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="prev">
          <GrPrevious className='icones-carr'/>
      ...
      >
        ...
        <section className='section-portfolio' style={{ backgroundImage: `url(${bgPorftolio})`}} >
          ...
          {portfolio
            .filter((processo) => !escondidos.includes(processo.id))
            .map((processo) => (
              <Processo
                processo={processo}
                onDelete={handleDeleteProcesso}
                onEsconder={handleEsconderProcesso}
                key={processo.id}
